    ...
    <div class="modal-content share-modal-content">
      ...
      <div id="share-card-node" class="share-card-wrapper">
        <div class="share-card-header">
          ...
          <span class="share-tag">AI 锐评与吐槽</span>
        </div>
        ...
        <div class="share-card-footer">
          <div class="share-qrcode-area">
            ...
            <div class="share-tip-text">
              <span class="primary">扫码体验 AI 毒舌锐评与一针见血剖析</span>
...
// 清理回复末尾的特殊标记 [RUIPING_SCORES]...[/RUIPING_SCORES]
const cleanContent = computed(() => {
  if (!props.content) return '';
  return props.content.replace(/\[RUIPING_SCORES\][\s\S]*?\[\/RUIPING_SCORES\]/gi, '').trim();
});
...
const handleCopy = async () => {
  try {
    const textToCopy = `【网腾无限AI - AI锐评与毒舌分析】\n\n${cleanContent.value}\n\n体验一针见血AI毒舌吐槽：https://ai.wuxian.xyz`;
